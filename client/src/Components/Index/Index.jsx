...
import RecentPost from "./Child/RecentPost";
    ...
    return (
        <main className="relative h-auto w-full">
            ...
            <section className="relative h-[100vh] w-full">
                ...
                <div className="fixed bottom-1 left-3 flex flex-col items-center gap-1">
            ...
            <section className="relative flex justify-center items-start gap-10 h-auto w-[80%] m-auto ">
                <Article />
                <RecentPost />
            </section>
