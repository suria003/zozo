    ...
    return (
        <div className="relative right-[65px] flex flex-row justify-center items-center gap-4 h-auto w-full">
            <div className="flex flex-col justify-center items-center gap-4 h-auto w-full" >
                <h2 className="text-[16.8px] text-[#0000009a]">GET CONNECT</h2>

                <ul className="flex flex-col justify-center items-center gap-3">
                    <span className="flex flex-row justify-center items-center gap-3 h-10 w-40 bg-black text-[#fff] rounded cursor-pointer hover:bg-[#0077B5]"><FaLinkedinIn className="h-[25px] w-[25px] cursor-pointer hover:text-[#fff]" />LinkedIn</span>
                    <span className="flex flex-row justify-center items-center gap-3 h-10 w-40 bg-black text-[#fff] rounded cursor-pointer hover:bg-[#1da1f2]"><FaXTwitter className="h-[25px] w-[25px] cursor-pointer hover:text-[#fff]" />Twitter</span>
                    <span className="flex flex-row justify-center items-center gap-3 h-10 w-40 bg-black text-[#fff] rounded cursor-pointer hover:bg-[#229ED9]"><FaTelegramPlane className="h-[25px] w-[25px] cursor-pointer hover:text-[#fff]" />Telgram</span>
                </ul>
            </div>
