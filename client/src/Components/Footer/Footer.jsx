...
export default function Footer() {
    return (
        <footer className="relative flex flex-col justify-center items-center gap-5 w-full h-auto py-10 overflow-hidden">
            ...
            <section className="relative h-auto w-[90%]">
                <div className="flex flex-row justify-center items-center gap-5">
                    <FaLinkedin className="h-[35px] w-[35px] text-[#000] cursor-pointer" onClick={ () => window.location.href = ""} />
                    <FaSquareXTwitter className="h-[35px] w-[35px] text-[#000]] cursor-pointer" onClick={ () => window.location.href = ""} />
                    <FaTelegram className="h-[35px] w-[35px] text-[#000000] cursor-pointer" onClick={ () => window.location.href = ""} />
                </div>
